...
|:---------------------------|--:|:---------------------------|--:|
| | | | |
| [MACAROON](#macaroon)          |   152 | [MÉTADONNÉES](#métadonnées)    |   156 |
...
| [MAINTENEUR (CORE)](#mainteneur-core) |   153 | [MINAGE ÉGOÏSTE](#minage-égoïste) |   157 |
...
| [MARKET CAP (CAPITALIZATION)](#market-cap-capitalization) |   154 | [MIT X11](#mit-x11)            |   160 |
| [MASF](#masf)                  |   154 | [MIXAGE](#mixage)              |   160 |
| [MAST](#mast)                  |   154 | [MODÈLE DE SCRIPT](#modèle-de-script) |   160 |
| [MASTER FINGERPRINT](#master-fingerprint) |   155 | [MODÈLE DE TRANSACTION](#modèle-de-transaction) |   160 |
...
|:---------------------------|--:|:---------------------------|--:|
| | | | |
| [NESTED SEGWIT](#nested-segwit) |   164 | [NOEUD LIGHTNING](#noeud-lightning) |   166 |
...
| [NLOCKTIME](#nlocktime)        |   164 | [NSEQUENCE](#nsequence)        |   167 |
| [NO2X](#no2x)                  |   165 | [NULL DATA](#null-data)        |   167 |
...
Standard de scripts utilisé pour envelopper des scripts SegWit natifs, au sein d'un script P2SH. Les scripts Nested SegWit ont été inventé au lancement de SegWit pour faciliter son adoption. Ils permettent d'utiliser ce nouveau standard, même avec des services ou des wallets pas encore compatibles nativement avec SegWit. C'est une sorte de script de transition vers la nouvelle norme. Aujourd'hui, il n'est donc plus très pertinent d'utiliser ce type de scripts SegWit wrappés, puisque la plupart des wallets ont implémenté du SegWit natif.
...
\begin{itemize}
  \item L'adoption de SegWit avec un seuil d'activation fixé à 80 pour cent de signalisation ;
