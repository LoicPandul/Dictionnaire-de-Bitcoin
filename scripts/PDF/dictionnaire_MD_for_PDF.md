...
| [DDOS](#ddos)                  |   102 | [DNS SEEDS](#dns-seeds)        |   106 |
...
\begin{codeblock}
limite de poussière = (taille de l'entrée + taille de la sortie) * taux de frais
\end{codeblock}
...
\begin{codeblock}
limite de poussière (sats) = (148 + 34) * 3000 / 1000 = 546 sats
\end{codeblock}
