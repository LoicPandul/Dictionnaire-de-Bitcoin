...
Pour contribuer, merci de bien vouloir écrire la modification et utiliser une Pull Request pour la soumettre à vérification face à [la branche de rédaction](https://github.com/LoicPandul/Dictionnaire/tree/R%C3%A9daction). Si vous effectuez de nombreuses modifications, merci de bien vouloir effectuer un commit pour chacune d'entres-elles afin de pouvoir choisir individuellement les modifications.
