...
Gossip ( ou « bavardages » ) désigne un algorithme distribué pair à pair (P2P) pour diffuser l'information de manière épidémique à tous les agents du réseau. Pour Bitcoin, Lightning et beaucoup d'autres système distribués, ce protocol permet d'échanger et synchroniser l'état global des noeuds en peu de cycles. Chaque noeud propage une information à un ou plusieurs voisins choisis aléatoirement ou non, ces derniers à leur tours, propagent l'information à d'autres voisins et ainsi de suite jusqu'à arriver à un état synchronisé globalement.
