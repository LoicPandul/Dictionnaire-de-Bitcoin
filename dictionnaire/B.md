...
► ***NOTE :** Pour plus d'informations, voir la définition de **[SCORE (SCORE BASED METHOD)](./S.md#score-score-based-method)**.*
...
► ***NOTE :** Pour plus d'informations, voir la définition de [**ENDIANNESS**](./E.md#endianness).*
