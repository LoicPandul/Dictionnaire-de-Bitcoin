...
> ► *On parle également parfois de « Atomic Multi-Part Payment » pour désigner cette même méthode. Pour plus d'informations, voir la définition de **[MULTI-PATH PAYMENT (MMP)](./M.md#multi-path-payments-mmp).*
