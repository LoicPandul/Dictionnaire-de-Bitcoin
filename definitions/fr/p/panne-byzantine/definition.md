...
> ► *La panne byzantine fait référence au problème des généraux byzantins, une métaphore traitant de la remise en cause de la fiabilité des transmissions et de l'intégrité des interlocuteurs. Pour plus d'informations, voir la définition de **[PROB. DES GÉNÉRAUX BYZANTINS](./P.md#prob.-des-généraux-byzantins)**.*