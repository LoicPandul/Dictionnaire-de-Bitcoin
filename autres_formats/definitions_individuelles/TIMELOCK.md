...
► ***NOTE :** Pour plus d'informations, voir la définition de [**OP_CHECKLOCKTIMEVERIFY**](/dictionnaire/O.md#op_checklocktimeverify-0xb1), [**OP_CHECKSEQUENCEVERIFY**](/dictionnaire/O.md#op_checksequenceverify-0xb2), [**NLOCKTIME**](/dictionnaire/N.md#nlocktime) et [**NSEQUENCE**](/dictionnaire/N.md#nsequence).*
